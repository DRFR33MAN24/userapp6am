              ...
              return GetBuilder<StoreController>(builder: (storeController) {
                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    print(
                        "dbg ${orderController.distance} ${storeController.store.minimumShippingCharge}");
                    ...
                    if (storeController.store != null &&
                      ...
                      if (_deliveryCharge <
                        ...
                        orderController.distance != -1) {
                      _deliveryCharge = orderController.distance *
                          _moduleData.perKmShippingCharge;
                      _charge = orderController.distance *
                          _moduleData.perKmShippingCharge;
                      ...
                      } else if (_moduleData.maximumShippingCharge != null &&
                    ...
                    if (storeController.store != null &&
                      ...
                      _deliveryCharge =
                          _deliveryCharge + orderController.extraCharge;
                                                    ...
                                                    DropdownButton(
                                                      ...
                                                      onChanged:
                                                        ...
                                                        if (storeController
                                                            ...
                                                            0) {
                                                          print(
                                                              'dbg location changed ${index} ${locationController.addressList[index].latitude}');
                                                          orderController
                                                              .getDistanceInKM(
                                                            LatLng(
                                                              double.parse(index ==
                  ...
                  ? () {
                      ...
                      if (!_isCashOnDeliveryActive &&
                        ...
                        showCustomSnackBar(Get.find<SplashController>()
                          ...
                          widget.storeId == null) {
                        showCustomSnackBar('you_cant_order_more_then'.tr +
                            ' ${PriceConverter.convertPrice(maxCodOrderAmount)} ' +
                        ...
                        AddressModel _address = orderController.addressIndex ==
                                -1
                            ? Get.find<LocationController>().getUserAddress()
                            : locationController
                                ...
                                if (cart.foodVariations[i].contains(true)) {
                                  ...
                                  for (int j = 0;
                                    ...
                                    if (cart.foodVariations[i][j]) {
                                      _variations[_variations.length - 1]
                                          .values
                                          .label
