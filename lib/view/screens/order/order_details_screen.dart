        ...
        body: GetBuilder<OrderController>(builder: (orderController) {
          ...
          if (orderController.orderDetails != null && _order != null) {
            ...
            if (_prescriptionOrder) {
              ...
              _itemsPrice =
                  (orderAmount + _discount) - (_tax + _deliveryCharge);
            } else {
          ...
          return orderController.orderDetails != null && _order != null
              ? Column(children: [
                  Expanded(
                      child: Scrollbar(
                        ...
                        child: SizedBox(
                            ...
                            child: Column(
                                ...
                                children: [
                                                ...
                                                onTap: () => Get.dialog(
                                                    ReviewDialog(
                                                        ...
                                                        fromOrderDetails:
                                                            true)),
                                                child: Text(
                                                  '${_order.cancellationReason != null ? _order.cancellationReason : ''}',
                                                  maxLines: 2,
                                                  overflow:
                                  ...
                                  (_order.orderStatus == 'refund_requested' ||
                                          _order.orderStatus ==
                                              'refund_request_canceled')
                                      ? Column(
                                          crossAxisAlignment:
                                                      ...
                                                      children: [
                                                          RichText(
                                                              text: TextSpan(
                                                                ...
                                                                TextSpan(
                                                                    text:
                                                                        '(${(_order.refund != null) ? _order.refund.customerReason : ''})',
                                                                    style: robotoRegular.copyWith(
                                                                        color: Theme.of(context)
                                                                            .textTheme
                                                                            .bodyLarge
                                                          ...
                                                          (_order.refund !=
                                                              ...
                                                              ? InkWell(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    image: _order.refund !=
                                                                            null
                                                                        ? '${Get.find<SplashController>().configModel.baseUrls.refundImageUrl}/${_order.refund.image.isNotEmpty ? _order.refund.image[0] : ''}'
                                                                        : '',
                                                                  ),
                                                                )
                                                              : SizedBox(),
                                                          ...
                                                          InkWell(
                                                            onTap: () => Get.dialog(ReviewDialog(
                                                                ...
                                                                fromOrderDetails:
                                                                    true)),
                                                            child: Text(
                                                              '${_order.refund != null ? _order.refund.adminNote : ''}',
                                                              maxLines: 2,
                                                              overflow:
                                                                  TextOverflow
                                                                      .ellipsis,
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      return Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () => openDialog(
                                                              context,
                                                              '${Get.find<SplashController>().configModel.baseUrls.orderAttachmentUrl}/${_order.orderAttachment[index]}'),
                                                          child: Center(
                                                              child: ClipRRect(
                                                            borderRadius:
                  ...
                  ResponsiveHelper.isDesktop(context)
                      ? SizedBox()
                      : _bottomView(orderController, _order, _parcel, _total),
                ])
                              ...
                              Get.dialog(ConfirmationDialog(
                                  ...
                                  onYesPressed: () {
                                    if ((((_maxCodOrderAmount != null &&
                                      ...
                                      showCustomSnackBar('you_cant_order_more_then'
                                              .tr +
                                          ' ${PriceConverter.convertPrice(_maxCodOrderAmount)} ' +
                                          'in_cash_on_delivery'.tr);
                                    }
                                  }));
                            },
                          ),
