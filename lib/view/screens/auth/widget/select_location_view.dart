      ...
      return SizedBox(
          ...
          child: Padding(
            padding: EdgeInsets.all(
                widget.fromView ? 0 : Dimensions.PADDING_SIZE_SMALL),
            child: SingleChildScrollView(
              child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        var _p = await Get.dialog(LocationSearchDialog(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: GetBuilder<LocationController>(
                              ...
                              return Text(
                                locationController.pickAddress.isEmpty
                                    ? 'search'.tr
                    ...
                    authController.zoneList.length > 0
                        ? Container(
                            height:
                                widget.fromView ? 200 : (context.height * 0.55),
                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(clipBehavior: Clip.none, children: [
                                ...
                                Center(
                                    child: Image.asset(Images.pick_marker,
                                        height: 50, width: 50)),
                                widget.fromView
                                    ? Positioned(
                                        top: 10,
                        ...
                        : SizedBox(),
                    SizedBox(
                        height: authController.zoneList.length > 0
                        ...
                        ? Row(children: [
                            Expanded(
                              ...
                              controller: TextEditingController(
                                text: authController.restaurantLocation != null
                                    ? authController.restaurantLocation.latitude
                                        .toString()
                                    : '',
                              ),
                              isEnabled: false,
                    ...
                    authController.zoneIds != null
                            ...
                            child: DropdownButton<int>(
                              ...
                              items: _zoneIndexList.map((int value) {
                                return DropdownMenuItem<int>(
                                  value: value,
                                  child:
                                      Text(authController.zoneList[value].name),
                                );
                              }).toList(),
                              onChanged: (value) {
                                // _polygons = HashSet();
                        ...
                        : Center(
                            child:
                                Text('service_not_available_in_this_area'.tr)),
                    SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                    !widget.fromView
                        ? CustomButton(
